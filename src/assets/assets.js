...
export const products = [
    ...
    },
    {
        _id: "aaaca",
        name: "Cartel",
        description: "A stylish cotton t-shirt with a modern graphic print, suitable for all genders and perfect for casual wear.",
        price: 290,
        image: [v1], // use the imported image
        category: "Men",
        subCategory: "Topwear",
        sizes: ["S", "M", "L", "XL"],
        date: Date.now(), // or a specific timestamp
        bestseller: true
    },
    {
        _id: "aaacb",
        ...
        description: "A stylish cotton t-shirt with a modern graphic print, suitable for all genders and perfect for casual wear.",
        price: 290,
        image: [v2], // use the imported image
        category: "Men",
        subCategory: "Topwear",
        sizes: ["S", "M", "L", "XL"],
        date: Date.now(), // or a specific timestamp
